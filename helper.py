...
def data_over_time(df,col):
    info_over_time = df.drop_duplicates(['Year', col])['Year'].value_counts().reset_index().sort_values('Year')
    info_over_time.rename(columns={'Year': 'Edition', 'count': col}, inplace=True)
